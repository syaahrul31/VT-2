  ...
  return (
    <div className="pattern min-h-screen flex items-center justify-center">
      ...
      <div className="max-w-4xl bg-white rounded-3xl shadow-lg overflow-hidden flex">
        ...
        <h1 className='logo absolute text-3xl text-white mt-16 ml-16'>Villa Tiara</h1>
          <img
        ...
        <div className="w-full md:w-1/2 p-20">
          ...
          <p className="text-center text-gray-600 mb-8">Selamat Datang di Villa Tiara</p>
          <form action="#" method="POST" className="space-y-5">
            ...
            <div className="flex items-center space-x-2">
              ...
              />
              <label htmlFor="not-robot" className="text-sm text-gray-700">Saya bukan robot</label>
            </div>
            {/* Tombol Login */}
            <button
            type="submit"
            ...
            <Link to="/" className="flex items-center justify-center text-sm text-gray-500 hover:text-yellow-500">
