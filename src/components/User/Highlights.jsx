const sections = [
  {
    ...
    caption2: "Nikmati keindahan dan ketenangan Telaga Sarangan, tempat yang sempurna untuk melepas penat dan menikmati alam.",
  ...
  },
  {
    ...
    caption2: "Ruang pertemuan nyaman dengan pemandangan indah, cocok untuk ngobrol santai, bekerja, atau bertemu dengan teman.",
  ...
  },
  {
    ...
    caption2: "Cafe Tiara menghadirkan suasana hangat dan nyaman, tempat terbaik untuk bersantai sambil menikmati hidangan lezat.",
              ...
              <div className="flip-card-front rounded-3xl relative border-4">
                ...
                <div className="absolute bottom-0 left-0 right-0 h-1/2 bg-gradient-to-t from-black to-transparent rounded-3xl">
                  <div className="absolute inset-8 items-center justify-center">
                    ...
                    <p className="text-white text-center text-sm font-normal">{section.caption}</p>
                  </div>
                </div>
              </div>
              {/* Sisi Belakang */}
