...
function Sidebar() {
  ...
  return (
    <>
      <aside id="sidebar" className={`fixed inset-y-0 left-0 w-64 bg-gradient-to-b from-red-700 to-orange-700 text-white h-screen transition-transform transform md:translate-x-0 ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'}`}>
