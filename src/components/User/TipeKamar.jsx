  ...
  return (
    <div className="container mx-auto my-14 px-4 md:px-10 justify-center items-center">
      <section className="text-center mb-6">
        <h1 className="text-3xl md:text-5xl font-bold">Tipe <span className="text-red-600">Kamar</span></h1>
        <p className="text-gray-700 text-md md:text-md py-4">Temukan jenis kamar yang sesuai dengan kebutuhan dan nikmati kenyamanan serta fasilitas terbaik dari Villa Tiara Sarangan.</p>
      </section>
        ...
        {rooms.map((room) => (
          <div key={room.type} className="w-full md:w-1/4 mx-4 rounded-xl overflow-hidden shadow-lg transition-transform transform hover:scale-105">
            ...
            <div className="py-6 px-10 bg-white">
              ...
              <Link to="/tipe-kamar" className="text-sm inline-flex items-center py-2 px-4 bg-orange-600 text-white rounded-lg hover:bg-yellow-500 transition duration-300">View More <FaArrowRight className="ml-2" /></Link>
            </div>
          </div>
        ))}
      </section>
